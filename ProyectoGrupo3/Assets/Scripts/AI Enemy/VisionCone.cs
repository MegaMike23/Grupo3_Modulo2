...
public class VisionCone : MonoBehaviour
{
    ...
    public Material VisionConeDetectMaterial;
    public float VisionRange;
    public float VisionAngle;
    public LayerMask VisionObstructingLayer;//layer with objects that obstruct the enemy view, like walls, for example
    public LayerMask PlayerLayer; //Detect player
    ...
    void DrawVisionCone()//this method creates the vision cone mesh
    {
        ...
        for (int i = 0; i < VisionConeResolution; i++)
        {
            ...
            //Detect Player by Layer
            if (Physics.Raycast(transform.position, RaycastDirection, out RaycastHit hitPlayer, VisionRange, PlayerLayer))
            {
                //Detect PLAYER
